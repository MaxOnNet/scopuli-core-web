...
from Scopuli.Interfaces.MySQL.Schema.Web import WebSite
...
class WebWidgetSocial(Base, Schema):
    ...
    cd_web_widget_social_type = Column(Integer(), ForeignKey('web_widget_social_type.id'), index=True, nullable=False, doc="Ссылка на WebWidgetSocialType")
